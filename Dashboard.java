...
public class Dashboard extends JFrame implements ActionListener{
    ...
    String username;
    JButton addPersonalDetails, viewPersonalDetails, updatePersonalDetails, checkpackages, bookpackage, viewpackage, viewhotels, destinations, bookhotels, viewBookedHotel, payments, calculator, notepad, about, deletePersonalDetails;
     Dashboard(String username){
       ...
       JPanel p2=new JPanel();
        ...
        viewhotels.setBounds(0, 310, 300, 45);
        ...
        bookhotels.setBounds(0, 355, 300, 45);
        ...
        viewBookedHotel.setBounds(0, 390, 300, 48);
        ...
        destinations.setBounds(0, 430, 300, 48);
        ...
        payments.setBounds(0, 470, 300, 48);
        ...
        calculator.setBounds(0, 510, 300, 48);
        ...
        notepad.setBounds(0, 550, 300, 48);
       ...
       Image i5=i4.getImage().getScaledInstance(1400, 900, Image.SCALE_DEFAULT);
       ImageIcon i6=new ImageIcon(i5);
       JLabel image=new JLabel(i6);
       image.setBounds(0, 0, 1400, 850);
       add(image);
