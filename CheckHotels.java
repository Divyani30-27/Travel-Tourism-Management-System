...
public class CheckHotels extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run(){
        String[] text = new String[]{"JW Marriott Hotel", "Madarin Oriental Hotel", "Four season Hotel", "Taj Hotel", "Spring Hotel", "Raddisson Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Happy Morning Hotel", "River View Hotel"};
